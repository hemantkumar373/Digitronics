...
mongoose.connect("mongodb://0.0.0.0:27017/nodeDb");
...
app.post("/upload",upload.single('product'),(req,res)=>{
    res.json({
        ...
        // image_url:`http:localhost:${port}/images/product_1712919339139.webp}`
    })
})
...
app.get('/popularinlaptop',async (req,res)=>{
    ...
    let popularcollection =products.slice(0).slice(-8);
